...
create table likes(
	...
	from_user_id bigint unsigned not null,
	to_user_id bigint unsigned not null,
	foreign key (from_user_id) references photos(id),
	foreign key (from_user_id) references media(id),
	foreign key (from_user_id) references posts(id),
	foreign key (from_user_id) references users(id),
	foreign key (to_user_id) references photos(id),
	foreign key (to_user_id) references media(id),
	foreign key (to_user_id) references posts(id),
	foreign key (to_user_id) references users(id)
);
